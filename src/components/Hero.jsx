...
const Hero = () => (
    <>
        <div style={{ background: '#2a2a2a', maxHeight: 'calc(15rem + 12vw)', zIndex: '1', paddingTop: '1rem',position:'relative'}}>
            ...
            <div  className="d-flex justify-content-end align-items-center" style={{width:'44%' ,height: 'calc(18rem + 17vw)',position:"absolute",top:'1rem',right:'6.5vw',background:"#3c3c3cf0",padding:'0 3vw'}}>
                    <div className='text-light' style={{textAlign:"end"}}>
                        ...
                        <button style={{fontSize:'calc(.7rem + .1vw)',padding:'calc(.3rem + .4vw) calc(.5rem + 1vw)',background:'#151515',color:'white',outline:'1px solid #151515',outlineOffset:'6px',margin:'5px'}}>GET STARTED</button>
                    </div>
            </div>
        </div>
        <Feature />
